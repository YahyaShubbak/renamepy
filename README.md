...
│                                             │
│ ☑ Include date in filename  Format: YYYY-MM-DD │
│ Camera Prefix: [A7R3        ] ℹ️           │
│ Additional:    [vacation    ] ℹ️           │
│ Devider:       [-] ▼         ℹ️           │
│                                             │
│ Interactive Preview: ℹ️                    │
│ ┌─────────────────────────────────────────┐ │
│ │ [2025-07-25] - [A7R3] - [vacation] - [001] │ │
│ └─────────────────────────────────────────┘ │
│                                             │
│ ☐ Include camera model (Sony ILCE-7RM3)    │
│ ☐ Include lens model (FE 24-70mm F2.8 GM)  │
│                                             │
│ ┌─── File List ────────────────────────────┐ │
